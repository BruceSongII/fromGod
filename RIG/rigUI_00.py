...
class SK_RigUI(object):
    ...
    def displayUI(self):
        ...
        if rig.window(RigGUI,exists=True):
            rig.deleteUI(RigGUI)
        rig.window(RigGUI,title=' 2009 AutoRig',menuBar=True,wh=  (400,500),minimizeButton=True,maximizeButton=True)
    ...
    def buildSetup(self):
        SK_combinationFinal()
        SK_SelectProject(self.OrigenRB,self.WoodliesRB,self.WinxTVRB)#选择项目
